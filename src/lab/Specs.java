...
public class Specs {
    ...
    /**
     * ฟังก์ชันนี้ทำการค้นหาตำแหน่งแรกที่เจอ key ที่กำหนดในอาร์เรย์ arr
     * @param arr อาร์เรย์ที่ถูกค้นหา
    ...
    /**
     * ฟังก์ชันนี้ทำการคำนวณพื้นที่ของวงกลม
     * @param radius ค่ารัศมีของวงกลม
     * @return คืนค่าพื้นนที่ของวงกลม
    ...
    /**
     * ฟังก์ชันนี้ตัดช่องว่างหน้าหลังแล้วแปลงตัวพิมพ์เล็ก
     * @param s ข้อความ
     * @return ข้อความที่ตัดช่องว่างและแปลงเป็นตัวพิมพ์เล็ก หรือ ข้อความว่างหาก s เป็น null
     */
